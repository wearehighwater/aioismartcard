                ...
                <div class="col-lg-6">
                    <div class="description">
                        ...
                        <div class="graph-line">
                            <img src="{{public_path('images/how-bg-line1.svg')}}" width="694" height="575" alt="">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="description">
                        <div class="graph-line">
                            <img src="{{public_path('images/how-bg-line2.svg')}}" width="688" height="357" alt="">
                            <div class="pulsating-circle">
                                <div class="circle" style="animation-delay: -3s"></div>
                                <div class="circle" style="animation-delay: -2s"></div>
                                <div class="circle" style="animation-delay: -1s"></div>
                        ...
                        <div class="graph-line add">
                            <img src="{{public_path('images/how-bg-line3.svg')}}" width="703" height="692" alt="">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-6">
                    <div class="ico-holder">
                        <img src="{{get_field('how_it_works_section_3_image')}}" alt="" width="150" height="150">
                    </div>
    ...
    <section class="info-section2">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="image">
                        <img src="{{get_field('how_it_works_section_4_image')}}" alt="">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="description">
                        <div class="graph-line">
                            <img src="{{public_path('images/how-bg-line4.svg')}}" width="375" height="322" alt="">
                            <div class="pulsating-circle">
                                <div class="circle" style="animation-delay: -3s"></div>
                                <div class="circle" style="animation-delay: -2s"></div>
                                <div class="circle" style="animation-delay: -1s"></div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="description">
                        <div class="graph-line">
                            <img src="{{public_path('images/how-bg-line5.svg')}}" width="968" height="353" alt="">
                ...
                <div class="col-lg-6">
                    <div class="image">
                        <img src="{{get_field('how_it_works_section_5_image')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
